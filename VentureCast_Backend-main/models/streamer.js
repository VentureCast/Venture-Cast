...
const streamerSchema = new mongoose.Schema({
  ...
  ticker: { type: String, unique: true, sparse: true }, // Trading ticker symbol (e.g., "MRBS" for MrBeast)
  ...
  subscriberCount: { type: Number }, // Subscriber count (from YouTube/Twitch API)
...
streamerSchema.index({ category: 1 });
