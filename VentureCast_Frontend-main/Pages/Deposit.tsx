...
const Deposit = ({ }:any) => {
  ...
  const user = {firstName: 'Alexander', lastName: 'Creighton', cash: 1203067.59, accountNumber: '**** **** **** 1234'}; //user data
  ...
  const message = () => {
    if (user.cash < investmentNumber) {
      return ("Not enough cash for deposit")
    } else {
      return (formatCurrency(investmentNumber) + ' will be deposited into your VentureCast account.')
    }
  }
    ...
    <View style={styles.container}>
      ...
      <View style={styles.investmentContainer}>
        <Text style={styles.cashAvailable}>
          Cash Available for Deposit: {formatCurrency(user.cash)}
        </Text>
