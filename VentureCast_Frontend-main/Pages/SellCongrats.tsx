...
const SellCongrats = () => {
  ...
  const buyData = {name: 'Dude Perfect', ticker: 'DUPT', netBuy: 5000, icon: require('../Assets/Images/dude-perfect.png') }
    ...
    <>
      ...
      <View style={styles.container}>
        ...
        <View style={styles.midContainer}>
          ...
          <Text style={styles.buyTitle}>Sell Order Recieved!</Text>
