...
const SellPreview = ({ }:any) => {
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.previewContainer}>
        <View style={styles.thirdContainer}>
          <View style={styles.subContainer}>
            ...
            <Text style={styles.numberText}>{formatCurrency(71.00)}</Text>
          </View>
          <View style={styles.subContainer}> 
            <Text style={styles.previewText}>Number of Shares</Text>
            <Text style={styles.numberText}>141.55</Text>
          </View>
        </View>
        <View style={styles.thirdContainer}>
          <View style={styles.subContainer}>
            <Text style={styles.previewText}>Market Bid</Text>
            <Text style={styles.numberText}>{formatCurrency(71.20)}</Text>
          </View>
          <View style={styles.subContainer}> 
          ...
          <View style={styles.subContainer}>
            <Text style={styles.previewText}>Total Proceeds</Text>
      ...
      navigation.navigate('SellCongrats') // withdraw/deposit preview
        }}>
