...
const ShortInter = () => {
  ...
  const handleSave = () => {
    ...
    navigation.navigate('ShortStock') // need to go to this page and have calculation prepared from quantity --> global variables
  };
    ...
    <>
      ...
      <View style={styles.titleBox}>
        <View style = {styles.clipsSubTitle}>
          ...
          <Text style={styles.sectionTitle}>Short Sell Stock</Text>
        </View>
      </View>
